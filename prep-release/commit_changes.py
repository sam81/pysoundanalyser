...
def main(argv):
    ...
    f = open('pysoundanalyser_pack/_version_info.py', 'w')
    f.write("# -*- coding: utf-8 -*-\n\n")
    f.write('pysnd_version = "' + str(major_v) + '.' + str(minor_v) + '.' + str(minor_minor_v)+'"\n')
    f.write('pysnd_revno = ' + str(revno) + '\n')
    f.write('pysnd_builddate = "' + builddate + '"\n')
    f.close()
