...
#unpack the tarball
cmd2 = "tar -xvf " + "pysoundanalyser-pyqt4-" + ver + ".tar.gz"
os.system(cmd2)
#change name
#os.system("mv " + "pysoundanalyser-" + ver + " " + "pysoundanalyser-" + ver )

#copy debian files in the package build directory
cmd3 = "cp -R " + "../../pysoundanalyser/prep-release/launchpad_trusty/debian ./pysoundanalyser-pyqt4-" + ver 
os.system(cmd3)

#move into package build directory
os.chdir("pysoundanalyser-pyqt4-" + ver)
#build the package
#For Debian
